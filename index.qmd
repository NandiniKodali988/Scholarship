...
This heatmap highlights how different humanitarian agency types experience distinct patterns of violence. INGOs stand out as the most frequently targeted, particularly in ambushes (32.5%) and individual attacks (30.7%), likely due to their broad field presence and frequent travel in high-risk regions.
...
NNGOs, often deeply embedded in local communities, are heavily affected in crossfire (20.2%), underscoring the risks faced by local staff operating without the same security protocols or diplomatic protections available to international agencies.
...
Notably, around 16% of attacks occur in unknown contexts, pointing to significant gaps in reporting and documentation. This lack of clarity can hinder security planning and limit agencies' ability to adapt effectively to emerging threats.
