...
format:
  html:
    includes:
      in-header: fontawesome.html

---

![](plots/Formal_1_Resized.jpg){fig-align="center" width="30%"}
...
<style>
  ...
  .social-row a:hover {
    background-color: #6a88a8; /* Slightly lighter on hover */
  }
...
<div class="social-row">
  ...
  <a href="https://nandinikodali.georgetown.domains/portfolio/" target="_blank"> Website
  </a>

  <a href="https://github.com/NandiniKodali988" target="_blank"> GitHub
  </a>

  <a href="https://www.linkedin.com/in/nandini-kodali/" target="_blank"> LinkedIn
  </a>

  <a href="https://nandinikodali.georgetown.domains/portfolio/resume/Resume_May2025.pdf" target="_blank"> Resume
  </a>
</div>